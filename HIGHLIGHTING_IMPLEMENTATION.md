...
```
[Kawa Code] ActivePathHandler.handle() called for project: XXX
[Kawa Code] Received N highlight lines for project: XXX
[Kawa Code] Applying highlights to file: /path/to/file
[Kawa Code] Applied N highlights to: /path/to/file
[Kawa Code] Added highlight: /path/to/file:LineNumber
```
