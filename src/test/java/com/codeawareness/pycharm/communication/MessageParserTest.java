...
class MessageParserTest {
    ...
    void testParseSingleCompleteMessage() {
        String json = "{\"flow\":\"req\",\"domain\":\"code\",\"action\":\"test\"}\n";
    ...
    void testParseMultipleMessages() {
        String json = "{\"flow\":\"req\",\"domain\":\"code\",\"action\":\"test1\"}\n" +
                "{\"flow\":\"res\",\"domain\":\"code\",\"action\":\"test2\"}\n";
    ...
    void testParseWithEmptyMessage() {
        String json = "\n{\"flow\":\"req\",\"domain\":\"code\",\"action\":\"test\"}\n\n";
    ...
    void testMultipleFragmentsMultipleMessages() {
        ...
        List<Message> messages2 = parser.parse("\"action\":\"test1\"}\n{\"flow\":\"res\",");
        assertEquals(1, messages2.size());
        assertEquals("test1", messages2.get(0).getAction());

        // Fragment 3: Completes message 2
        List<Message> messages3 = parser.parse("\"action\":\"test2\"}\n");
