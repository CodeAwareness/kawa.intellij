...
This guide covers everything you need to publish the Kawa Code plugin to the JetBrains Marketplace so users can find and install it.
...
1. **Generate a Certificate**
   ...
   keytool -genkey -keyalg RSA -keysize 2048 -validity 10000 \
     ...
     -dname "CN=Kawa Code, OU=Development, O=Kawa Code Team, L=City, ST=State, C=US"
   ```
...
- ✅ Plugin name (already set: `Kawa Code`)
