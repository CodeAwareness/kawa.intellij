# Testing Guide for Kawa Code PyCharm Plugin

## Overview

This document describes the testing strategy for the Kawa Code PyCharm plugin, including unit tests, integration tests, and how to run them.
