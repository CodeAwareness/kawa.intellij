# Kawa Code PyCharm Plugin - Architecture Overview
...
This document outlines the architecture for the **Kawa Code PyCharm Plugin**, a JetBrains IDE extension that provides real-time team collaboration features. This plugin replicates the functionality of the existing Kawa Code extensions for Emacs and VS Code, enabling PyCharm users to see code intersections, conflicts, and overlaps with teammates before committing changes.
...
The Kawa Code PyCharm plugin enables developers to:
...
- Kawa Code message protocol specification (see kawa.emacs exploration)
