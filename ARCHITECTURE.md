...
- **Collaborate seamlessly** - Work across IDEs (Emacs, VSCode, PyCharm, IntelliJ) through shared backend
...
1. Generate unique GUID for IntelliJ instance
...
- Store peer files in `~/.cache/caw.intellij/` or system temp
...
<idea-plugin>
  ...
  <extensions defaultExtensionNs="com.intellij">
    ...
    <applicationService
        ...
        serviceImplementation="com.codeawareness.intellij.CodeAwarenessApplicationService"/>

    <projectService

        serviceImplementation="com.codeawareness.intellij.CodeAwarenessProjectService"/>
    ...
    <projectConfigurable
        ...
        instance="com.codeawareness.intellij.settings.CodeAwarenessConfigurable"/>
  ...
  <applicationListeners>
    ...
    <listener
        ...
        class="com.codeawareness.intellij.listeners.FileChangeListener"
  ...
  <projectListeners>
    ...
    <listener
        ...
        class="com.codeawareness.intellij.listeners.ActiveFileListener"
...
4. **Multi-IDE Support**
   ...
   - Plugin variants for WebStorm, Rider, CLion, etc.
...
src/main/java/com/codeawareness/intellij/
...
- kawa.pycharm repository (reference implementation for JetBrains platform)

- kawa.emacs repository (original implementation)
...
**Key Advantages of IntelliJ Platform Reuse:**

- PyCharm and IntelliJ IDEA share the same underlying platform

- Most code can be directly reused from kawa.pycharm implementation

- Only package names and plugin metadata need to be adapted

- Testing and debugging strategies are identical
