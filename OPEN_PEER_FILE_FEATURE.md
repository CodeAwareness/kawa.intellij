...
```
[Kawa Code] OpenPeerFileHandler.handle() called for project: XXX
[Kawa Code] Opening peer file: /path/to/file (exists locally: true/false, peerId: XXX)
[Kawa Code] Opened file in editor: /path/to/file
[Kawa Code] Opened diff view for peer file
```
